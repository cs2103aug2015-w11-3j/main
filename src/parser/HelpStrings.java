...
public class HelpStrings {
    ...
    /////////////////////////////////////////////////////////////////
    public static final String HELP_LIST_ALL_CMDS = "ALL CMDS: skin | help/quit | add/delete/edit | mark/unmark | show | undo/redo | search/filter/clear | move";
    ...
    public static final String HELP_FORMAT_ALIAS = "Set Alias for Command: \"%1$s <target command name in \"help\"> <new alias>\"   \"%1$s reset\"";
